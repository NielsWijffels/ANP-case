#!/usr/bin/env python3
"""Build the Colab notebook as valid .ipynb JSON"""
import json
...
# Write
with open("RANST_Colab_Streaming.ipynb", "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=2, ensure_ascii=False)

print(f"Notebook geschreven: {len(nb['cells'])} cells")
